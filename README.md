The following program named 'sci-bot.py' allows a user to enter a query and receive a response. The response is generated by searching for a relevant Wikipedia article 
